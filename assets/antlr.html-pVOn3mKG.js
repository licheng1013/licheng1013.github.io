import{_ as e,o as n,c as a,d as i}from"./app-Bmz9YWq3.js";const l={},t=i(`<h1 id="antlr" tabindex="-1"><a class="header-anchor" href="#antlr"><span>Antlr</span></a></h1><h2 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍"><span>介绍🍇</span></a></h2><ul><li>2022/11/18</li><li>版本 antlr4</li></ul><h2 id="符号作用" tabindex="-1"><a class="header-anchor" href="#符号作用"><span>符号作用🍎</span></a></h2><h2 id="示例" tabindex="-1"><a class="header-anchor" href="#示例"><span>示例🌟</span></a></h2><h3 id="json" tabindex="-1"><a class="header-anchor" href="#json"><span>JSON💞</span></a></h3><div class="language-antlr line-numbers-mode" data-ext="antlr" data-title="antlr"><pre class="language-antlr"><code>grammar JSON;
json: value EOF;
