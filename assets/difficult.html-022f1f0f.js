...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="使用注意" tabindex="-1"><a class="header-anchor" href="#使用注意" aria-hidden="true">#</a> 使用注意</h3><ul><li>select什么情况下会阻塞?</li></ul><div class="hint-container tip"><p class="hint-container-title">答</p><ul><li>当select语句没有任何case语句准备好，也没有default语句时，它就会阻塞，直到至少有一个case语句可以执行1。</li><li>这意味着select语句会等待所有的channel操作，直到有一个channel可以收到或发送数据2。</li><li>如果你想避免select语句阻塞，你可以使用default语句或者超时机制。</li></ul></div><h2 id="线程" tabindex="-1"><a class="header-anchor" href="#线程" aria-hidden="true">#</a> 线程</h2><h3 id="轻量级线程的局部变量" tabindex="-1"><a class="header-anchor" href="#轻量级线程的局部变量" aria-hidden="true">#</a> 轻量级线程的局部变量?</h3><div class="hint-container tip"><p class="hint-container-title">答</p><ul><li>Go 语言支持并发，可以通过 go 关键字来开启 goroutine，也就是轻量级线程。goroutine 的调度是由 Go 运行时进行管理的。</li><li>当启动一个 goroutine 时，它会继承当前函数的局部变量的值，并在自己的栈上创建一个副本。如果局部变量是指针或引用类型，</li><li>那么 goroutine 可能会访问或修改共享的数据。为了避免数据竞争或不一致的问题，</li><li>Go 语言提供了 sync 包中的互斥锁 Mutex 和读写锁 RWMutex 来限制多个 goroutine 对同一个变量的访问3。</li><li>你可以使用 sync.Mutex 的 Lock 和 Unlock 方法来保护临界区域，</li><li>或者使用 sync.RWMutex 的 RLock 和 RUnlock 方法来允许多个读操作同时进行，但只允许一个写操作进行。</li></ul></div><h3 id="goroutine和线程区别" tabindex="-1"><a class="header-anchor" href="#goroutine和线程区别" aria-hidden="true">#</a> goroutine和线程区别？</h3><div class="hint-container tip"><p class="hint-container-title">答</p><ul><li>goroutine 是 Go 语言运行时管理的轻量级线程，而线程是操作系统管理的执行单元。</li><li>goroutine 的切换开销比线程小得多，因为 goroutine 的切换只涉及三个寄存器的值修改，而线程的切换涉及模式切换、寄存器刷新等操作。</li><li>goroutine 的栈空间比线程动态灵活，goroutine 一般只需要 2KB 的栈内存，而线程通常需要 2MB。goroutine 的栈大小会根据需要动态地伸缩，而线程的栈大小是固定不变的。</li><li>goroutine 可以轻松创建成千上万个，并发执行，而线程的数量受到操作系统和硬件资源的限制。</li></ul></div>`,17),o=[p];function i(c,l){return s(),a("div",null,o)}const r=n(e,[["render",i],["__file","difficult.html.vue"]]);export{r as default};
