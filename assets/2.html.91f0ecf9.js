import{_ as n}from"./log.88ec32b8.js";import{_ as s,o as a,c as e,d as i}from"./app.3fbd19fe.js";const t={},l=i('<h1 id="_2-go变量" tabindex="-1"><a class="header-anchor" href="#_2-go变量" aria-hidden="true">#</a> 2-Go变量</h1><p><img src="'+n+`" alt=""></p><h2 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍" aria-hidden="true">#</a> 介绍</h2><ul><li>本文的作用</li><li>变量介绍</li><li>注释说明</li></ul><h2 id="注释" tabindex="-1"><a class="header-anchor" href="#注释" aria-hidden="true">#</a> 注释</h2><ul><li>排除掉不执行的代码片段</li><li>Go以 // 来作为注释开头</li><li>下面将会有例子进行尝试</li></ul><h2 id="变量" tabindex="-1"><a class="header-anchor" href="#变量" aria-hidden="true">#</a> 变量</h2><ul><li>变量是什么？ 您可以理解为是一个存储东西的盒子！</li><li>一个示例：a = 10 代表了 10 放入了这个 a 的盒子里面了！</li><li>当然变量也有类型的，就像衣服一样。有大衣款式也有小衣款式。</li><li>为什么要会这样说呢？你总得帮选个<strong>变量</strong>选择个合适的类型吧。如果实在不在知道选择多大的，那么选最大的就行了。</li><li>下面是Go的最常用的4种类型</li><li>类型之间转换是需要其他操作的，如果直接转换会出现错误的。目前暂不演示了。</li><li>main 是个方法，您现在不需要知晓方法的作用(如果已经知道了更好)。只需要跟着操作走即可。</li></ul><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> main
