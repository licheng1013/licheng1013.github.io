...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,8);function _(f,w){const n=d("ExternalLinkIcon");return r(),o("div",null,[u,e("ul",null,[v,e("li",null,[e("a",c,[s("http://www.axios-js.com/zh-cn/docs/vue-axios.html"),a(n)])]),m]),b,e("ul",null,[h,e("li",null,[e("a",p,[s("http://www.axios-js.com/zh-cn/"),a(n)])]),x]),g])}const j=l(t,[["render",_],["__file","axios.html.vue"]]);export{j as default};
